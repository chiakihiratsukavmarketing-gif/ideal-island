...
5. タスクを完了すると、今日・今月・年間の進捗に反映されます。今日タブで完了すると +1 MILE のトーストが表示され、ダッシュボードの MILE 数・ステージ・バッジ・連続達成も更新されます。
...
- **連続達成日数**: 今日または昨日から遡り、1日に1件以上完了がある連続日数（空白日でストップ）。
...
- Phase World-3: ステージ演出の微調整、バッジ追加、達成演出の改善
